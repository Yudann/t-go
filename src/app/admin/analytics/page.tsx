  ...
  const MetricCard = ({
    ...
    <Card
      className={`border shadow-sm overflow-hidden ${
        isDarkMode ? "bg-[#1A1A20] border-gray-800" : "bg-white border-gray-100"
      }`}
    >
      <CardContent className="p-5">
        ...
        <div
          className={`flex items-center mt-3 text-xs font-bold ${
  ...
  return (
    <div
      className={`p-6 space-y-6 min-h-full ${
        isDarkMode ? "bg-[#121216] text-white" : "bg-gray-50 text-gray-900"
      }`}
    >
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Select value={timeRange} onValueChange={setTimeRange}>
            <SelectTrigger
              className={`w-[150px] border-0 h-9 text-xs font-bold ${
                isDarkMode ? "bg-gray-800 text-white" : "bg-white shadow-sm"
              }`}
            >
            ...
            <SelectContent
              className={
                isDarkMode ? "bg-[#1A1A20] border-gray-800 text-white" : ""
              }
            >
                      ...
                      >
                        <div className="relative w-full flex justify-center h-full items-end">
                          <div
                            ...
                            style={{
                              height: `${Math.max(
                                (data.value / (stats.totalRevenue || 1)) * 1000,
                                10
                              )}%`,
                              minHeight: "20px",
                            }}
